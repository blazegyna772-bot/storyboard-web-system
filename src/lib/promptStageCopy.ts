export const backendPromptStageCopy: Record<string, { title: string; description: string }> = {
  ...
  asset_extract_chapter: { title: "按章资产识别（旧版）", description: "旧版按章混合提取角色、场景、道具。" },
  asset_extract_chapter_characters: { title: "按章角色资产识别", description: "按章节增量提取角色资产和角色版本。" },
  asset_extract_chapter_scenes: { title: "按章场景资产识别", description: "按章节增量提取空间、场景和场景状态。" },
  asset_extract_chapter_props: { title: "按章道具资产识别", description: "按章节增量提取关键道具和道具状态。" },
